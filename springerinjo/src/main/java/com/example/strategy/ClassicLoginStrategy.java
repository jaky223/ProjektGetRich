...
public class ClassicLoginStrategy implements LoginStrategy {
    ...
    public ResponseEntity<?> login(UserLoginRequest request) {
        ...
        if (identifier == null || identifier.trim().isEmpty()) {
            throw new IllegalArgumentException("Korisničko ime ili email ne smiju biti prazni");
        }
        ...
        if (user == null) {
            throw new IllegalArgumentException("Krivo korisničko ime/email ili lozinka");
        }
